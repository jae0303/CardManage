    ...
    calendars.clndr1 = $('.cal1').clndr({
        ...
        clickEvents: {
            click: function (target) {
                alert('Cal-1 clicked: '+target);
            },
            today: function () {
                alert('Cal-1 today: '+target);
            },
            nextMonth: function () {
                alert('Cal-1 next month: '+target);
            },
            previousMonth: function () {
                alert('Cal-1 previous month : '+target);
            },
            onMonthChange: function () {
                alert('Cal-1 month changed: '+target);
            },
            nextYear: function () {
                alert('Cal-1 next year: '+target);
            },
            previousYear: function () {
                alert('Cal-1 previous year: '+target);
            },
            onYearChange: function () {
                alert('Cal-1 year changed: '+target);
            },
            nextInterval: function () {
                alert('Cal-1 next interval: '+target);
            },
            previousInterval: function () {
                alert('Cal-1 previous interval: '+target);
            },
            onIntervalChange: function () {
                alert('Cal-1 interval changed: '+target);
            }
        },
        multiDayEvents: {
            singleDay: 'date',
